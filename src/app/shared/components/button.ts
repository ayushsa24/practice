...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  secondary: 'bg-slate-100 text-white-900 hover:bg-slate-200 focus:ring-slate-500',
...
export class Button{
    ...
    protected readonly hostClasses = computed(()=> {
        const base = 'inline-flex items-center justify-center rounded-md font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none ring-offset-slate-100'; 
